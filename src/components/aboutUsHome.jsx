          ...
          <div className="container">
            <div className="row justify-content-between align-items-center">
              ...
              <div className="col-lg-5 col-md-6 col-12 d-flex flex-column justify-content-center">
                ...
                <h5>If youve decided to enroll in one of Turkeys colleges, this is the first place to gain information about studying in Turkey and to get your free admission.</h5>
