export const en = {
  ...
  headerztechT: "A locally produced, 100% coded educational robot is being created in Turkey.",
  headerteknoT: "Exam Evaluation and Report Cards.",
  headerteknoP: `With the program designed for schools, study centers and tutoring offices, you can easily evaluate LGS, TYT, AYT, FOREIGN LANGUAGE, KPSS and many other exams from any optical reader. Regardless of the optical form, it can be adapted to the program in a few minutes. Once "After an adjustment, the same optical form can be used continuously in other exams."`,
  headk12netT: "FOR BETTER LEARNING.",
  headk12netP: "K12NET is a school management system that integrates technology to increase efficiency and communication between teachers, students, staff and parents.",
  headerklikP:
  "Kliksoft, digital image processing, graphic design and layout, web design and Internet application development, learning management system and e-development of training content, web conferencing and virtual classroom applications, digital audio and video editing, animation and modeling, and also the development of applications for mobile platforms under the names of the main integrated solutions Turkey software based company.",
  headerokulP:
  ...
  headerztechli1: "100% Domestic Production",
  headerztechli2: "Coding Without a Computer",
  headerztechli3: "More than 10 Sensors",
  headerztechli4: "Coding with Simulation",
  headerztechli5: "Personalization Possibilities",
